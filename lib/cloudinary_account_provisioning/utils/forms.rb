...
module CloudinaryAccountProvisioning
  module Utils
    ...
    sig {
      params(media_type: String, request: Object).returns(
        [String, Object, T::Array[T::Array[T.any(T::Array[T.nilable(String)], String)]]]
      )
    }
        ...
        if field_metadata[:file] == true
          ...
          if val.is_a?(Array)
            val.each do |file_obj|
              ...
              if T.unsafe(file_name) == "" || T.unsafe(content).nil?
                raise StandardError, "invalid multipart/form-data file"
              end
