  ...
  module Utils
    ...
    sig {
      params(
        ...
        gbls: T.nilable(T::Hash[Symbol, T::Hash[Symbol, T::Hash[Symbol, Object]]])
      )
    ...
    def self._get_delimited_query_params(metadata, field_name, obj, delimiter)
      ...
      _populate_form(
        field_name,
        T.cast(metadata.fetch(:explode, true), T::Boolean),
        obj,
        delimiter,
        &get_query_param_field_name
      )
    end
  end
end
