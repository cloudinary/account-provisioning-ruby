  ...
  module Utils
    ...
    sig do
      params(
        ...
        nullable: T::Boolean,
        optional: T::Boolean,
        request_field_name: Symbol,
        serialization_method: Symbol
      )
    ...
    def self.serialize_request_body(request, nullable, optional, request_field_name, serialization_method)
      ...
      if !request.respond_to?(:fields) || !request.respond_to?(request_field_name)
      ...
      serialize_content_type(
        request_metadata.fetch(:media_type, "application/octet-stream"),
        request_val
      )
    end
    ...
    def self.serialize_content_type(media_type, request)
      if media_type.match("^(application|text)\\/([^+]+\\+)*json.*")
        return media_type, ::Crystalline.to_json(request), nil
      end
